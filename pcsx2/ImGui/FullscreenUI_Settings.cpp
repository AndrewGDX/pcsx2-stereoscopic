...
void FullscreenUI::DrawGraphicsSettingsPage(SettingsInterface* bsi, bool show_advanced_settings)
{
	...
	MenuHeading(FSUI_CSTR("Filters"));
	{
		...
		const bool enable_auto_gamma = GetEffectiveBoolSetting(bsi, "EmuCore/GS", "StereoFix_EnableAutoGamma", false);
		const bool enable_luminance_blend = GetEffectiveBoolSetting(bsi, "EmuCore/GS", "StereoFix_EnableLuminanceBlend", false);
		const bool enable_levels = GetEffectiveBoolSetting(bsi, "EmuCore/GS", "StereoFix_EnableLevels", false);
		...
		DrawFloatRangeSetting(bsi, FSUI_CSTR("Contrast Intensity"), FSUI_CSTR("Maximum contrast boost applied to mid-tones."), "EmuCore/GS", "StereoFix_ContrastIntensity", 0.92f, 0.01f, 1.0f, "%.2f", 1.0f, enable_auto_gamma);
...
//			DrawFloatRangeSetting(bsi, FSUI_CSTR("Gamma Compensation Strength"), FSUI_CSTR("Strength of automatic gamma compensation."), "EmuCore/GS", "StereoFix_GammaCompStrength", 1.0f, 0.0f, 1.0f, "%.2f", 1.0f);
		...
		DrawFloatRangeSetting(bsi, FSUI_CSTR("Blend Opacity"), FSUI_CSTR("Maximum strength of the blend effect."), "EmuCore/GS", "StereoFix_Opacity", 0.22f, 0.0f, 1.0f, "%.2f", 1.0f, enable_luminance_blend);
...
//			DrawFloatRangeSetting(bsi, FSUI_CSTR("Blend Midpoint"), FSUI_CSTR("Center luminance for blend strength."), "EmuCore/GS", "StereoFix_LuminanceMidpoint", 0.5f, 0.4f, 0.5f, "%.3f", 1.0f);
		...
		DrawFloatRangeSetting(bsi, FSUI_CSTR("Black Level"), FSUI_CSTR("Raises the black point."), "EmuCore/GS", "StereoFix_BlackLevel", 0.0f, 0.0f, 16.0f, "%.0f", 1.0f, enable_levels);
		DrawFloatRangeSetting(bsi, FSUI_CSTR("White Level"), FSUI_CSTR("Lowers the white point."), "EmuCore/GS", "StereoFix_WhiteLevel", 0.0f, 0.0f, 32.0f, "%.0f", 1.0f, enable_levels);
		DrawFloatRangeSetting(bsi, FSUI_CSTR("Temperature"), FSUI_CSTR("Adjust red/blue color temperature."), "EmuCore/GS", "StereoFix_Temperature", 0.0f, -1.0f, 1.0f, "%.2f", 1.0f, enable_levels);
		DrawToggleSetting(bsi, FSUI_CSTR("CRT Filter"), FSUI_CSTR("Enable scanline pass before stereo image adjustments."), "EmuCore/GS", "StereoFix_EnableCRTFilter", false);
	}
