...
struct Pcsx2Config
{
	...
	struct GSOptions
	{
		...
		float StereoFix_Shift = 0.0f;
		float StereoFix_Tilt = 0.0f;
		float StereoFix_VignetteSize = 0.13f;
		float StereoFix_VignetteX = 0.75f;
		float StereoFix_VignetteY = 0.50f;
		float StereoFix_ExtendBorder = 0.0f;
		float StereoFix_CutOffset = 0.0f;
		float StereoFix_VignetteOffset = 0.0f;
		float StereoFix_ContrastIntensity = 0.92f;
		float StereoFix_MidpointFocus = 2.0f;
		float StereoFix_ContrastMidpoint = 0.5f;
		float StereoFix_GammaCompStrength = 1.0f;
		float StereoFix_Opacity = 0.22f;
		float StereoFix_MidpointFocus2 = 8.0f;
		float StereoFix_LuminanceMidpoint = 0.5f;
		...
		float StereoSeparation = 20.0f;
		float StereoConvergence = 20.0f;
		float StereoUiDepth = 0.0f;
		float StereoUiSecondLayerDepth = 0.0f;
		int StereoUiDetectMode = 3;
		int StereoUiDetectThreshold = 80;
		...
		bool StereoRenderCheckedObjectsSbsRemap = false;
		bool StereoRenderCheckedObjectsUI = false;
		bool StereoRequireTextureDisplayBuffer2 = false;
		bool StereoRejectTextureDisplayBuffer2 = false;
		bool StereoRequirePrimTme = false;
		bool StereoRejectPrimTme = false;
		bool StereoRequirePrimFst = false;
		bool StereoRejectPrimFst = false;
		bool StereoRequirePrimAbe = false;
		bool StereoRejectPrimAbe = false;
		bool StereoRequirePrimFge = false;
		bool StereoRejectPrimFge = false;
		bool StereoRequirePrimIip = false;
		bool StereoRejectPrimIip = false;
		bool StereoRequirePrimAa1 = false;
		bool StereoRejectPrimAa1 = false;
		bool StereoRequirePrimCtxt = false;
		bool StereoRejectPrimCtxt = false;
		bool StereoRequirePrimFix = false;
		bool StereoRejectPrimFix = false;
		bool StereoRequirePrimClassPoint = false;
		bool StereoRejectPrimClassPoint = false;
		bool StereoRequirePrimClassLine = false;
		bool StereoRejectPrimClassLine = false;
		bool StereoRequirePrimClassTriangle = false;
		bool StereoRejectPrimClassTriangle = false;
		bool StereoRequirePrimClassSprite = false;
		bool StereoRejectPrimClassSprite = false;
		bool StereoRequireTfxModeModulate = false;
		bool StereoRequireTfxModeDecal = false;
		bool StereoRejectTfxModeDecal = false;
		bool StereoRequireTfxModeHighlight = false;
		bool StereoRequireTfxModeHighlight2 = false;
		...
		bool StereoRejectSbsInput = false;
		bool StereoRejectTabInput = false;
		bool StereoMasterFixTest = false;
		bool StereoMasterFix1 = false;
		bool StereoMasterFix2 = false;
		bool StereoMasterFix3 = false;
		bool StereoMasterFix4 = false;
		bool StereoMasterFix5 = false;
		bool StereoMasterFixMovies = false;
		bool StereoRequireDisplayBuffer1 = false;
		bool StereoRequireDisplayBuffer2 = false;
		bool StereoRequirePerspectiveUV = false;
		bool StereoRequireZVaries = false;
		bool StereoRequireDepthActive = false;
		bool StereoRejectSprites = false;
		...
		bool StereoUniversalRejectRtaSourceCorrection = false;
		bool StereoUniversalRejectColclipHw = false;
		bool StereoUniversalRejectColclip = false;
		bool StereoUniversalRejectBlendMix = false;
		bool StereoUniversalRejectPabe = false;
		bool StereoUniversalRejectFbMask = false;
		bool StereoUniversalRejectTexIsFb = false;
		bool StereoUniversalRejectNoColor = false;
		bool StereoUniversalRejectNoColor1 = false;
		bool StereoUniversalRejectAemFmt = false;
		bool StereoUniversalRejectPalFmt = false;
		bool StereoUniversalRejectDstFmt = false;
		bool StereoUniversalRejectDepthFmt = false;
		bool StereoUniversalRejectAem = false;
		bool StereoUniversalRejectFba = false;
		bool StereoUniversalRejectFog = false;
		bool StereoUniversalRejectIip = false;
		bool StereoUniversalRejectDate = false;
		bool StereoUniversalRejectAtst = false;
		bool StereoUniversalRejectAfail = false;
		bool StereoUniversalRejectFst = false;
		bool StereoUniversalRejectTfx = false;
		bool StereoUniversalRejectTcc = false;
		bool StereoUniversalRejectWms = false;
		bool StereoUniversalRejectWmt = false;
		bool StereoUniversalRejectAdjs = false;
		bool StereoUniversalRejectAdjt = false;
		bool StereoUniversalRejectLtf = false;
		bool StereoUniversalRejectShuffle = false;
		bool StereoUniversalRejectShuffleSame = false;
		bool StereoUniversalRejectReal16Src = false;
		bool StereoUniversalRejectProcessBa = false;
		bool StereoUniversalRejectProcessRg = false;
		bool StereoUniversalRejectShuffleAcross = false;
		bool StereoUniversalRejectWriteRg = false;
		bool StereoUniversalRejectBlendA = false;
		bool StereoUniversalRejectBlendB = false;
		bool StereoUniversalRejectBlendC = false;
		bool StereoUniversalRejectBlendD = false;
		bool StereoUniversalRejectFixedOneA = false;
		bool StereoUniversalRejectBlendHw = false;
		bool StereoUniversalRejectAMasked = false;
		bool StereoUniversalRejectRoundInv = false;
		bool StereoUniversalRejectChannel = false;
		bool StereoUniversalRejectChannelFb = false;
		bool StereoUniversalRejectDither = false;
		bool StereoUniversalRejectDitherAdjust = false;
		bool StereoUniversalRejectZClamp = false;
		bool StereoUniversalRejectZFloor = false;
		bool StereoUniversalRejectTCOffsetHack = false;
		bool StereoUniversalRejectUrbanChaosHle = false;
		bool StereoUniversalRejectTalesOfAbyssHle = false;
		bool StereoUniversalRejectAutomaticLod = false;
		bool StereoUniversalRejectManualLod = false;
		bool StereoUniversalRejectPointSampler = false;
		bool StereoUniversalRejectRegionRect = false;
		bool StereoUniversalRejectScanmask = false;
		bool StereoRequireRtaCorrection = false;
		bool StereoUniversalRequireRtaSourceCorrection = false;
		bool StereoUniversalRequireColclipHw = false;
		bool StereoUniversalRequireColclip = false;
		bool StereoUniversalRequireBlendMix = false;
		bool StereoUniversalRequirePabe = false;
		bool StereoUniversalRequireFbMask = false;
		bool StereoUniversalRequireTexIsFb = false;
		bool StereoUniversalRequireNoColor = false;
		bool StereoUniversalRequireNoColor1 = false;
		bool StereoUniversalRequireAemFmt = false;
		bool StereoUniversalRequirePalFmt = false;
		bool StereoUniversalRequireDstFmt = false;
		bool StereoUniversalRequireDepthFmt = false;
		bool StereoUniversalRequireAem = false;
		bool StereoUniversalRequireFba = false;
		bool StereoUniversalRequireFog = false;
		bool StereoUniversalRequireIip = false;
		bool StereoUniversalRequireDate = false;
		bool StereoUniversalRequireAtst = false;
		bool StereoUniversalRequireAfail = false;
		bool StereoUniversalRequireFst = false;
		bool StereoUniversalRequireTfx = false;
		bool StereoUniversalRequireTcc = false;
		bool StereoUniversalRequireWms = false;
		bool StereoUniversalRequireWmt = false;
		bool StereoUniversalRequireAdjs = false;
		bool StereoUniversalRequireAdjt = false;
		bool StereoUniversalRequireLtf = false;
		bool StereoUniversalRequireShuffle = false;
		bool StereoUniversalRequireShuffleSame = false;
		bool StereoUniversalRequireReal16Src = false;
		bool StereoUniversalRequireProcessBa = false;
		bool StereoUniversalRequireProcessRg = false;
		bool StereoUniversalRequireShuffleAcross = false;
		bool StereoUniversalRequireWriteRg = false;
		bool StereoUniversalRequireBlendA = false;
		bool StereoUniversalRequireBlendB = false;
		bool StereoUniversalRequireBlendC = false;
		bool StereoUniversalRequireBlendD = false;
		bool StereoUniversalRequireFixedOneA = false;
		bool StereoUniversalRequireBlendHw = false;
		bool StereoUniversalRequireAMasked = false;
		bool StereoUniversalRequireRoundInv = false;
		bool StereoUniversalRequireChannel = false;
		bool StereoUniversalRequireChannelFb = false;
		bool StereoUniversalRequireDither = false;
		bool StereoUniversalRequireDitherAdjust = false;
		bool StereoUniversalRequireZClamp = false;
		bool StereoUniversalRequireZFloor = false;
		bool StereoUniversalRequireTCOffsetHack = false;
		bool StereoUniversalRequireUrbanChaosHle = false;
		bool StereoUniversalRequireTalesOfAbyssHle = false;
		bool StereoUniversalRequireAutomaticLod = false;
		bool StereoUniversalRequireManualLod = false;
		bool StereoUniversalRequirePointSampler = false;
		bool StereoUniversalRequireRegionRect = false;
		bool StereoUniversalRequireScanmask = false;
		bool StereoUniversalRequireAlphaBlend = false;
		bool StereoUniversalRequireAlphaTest = false;
		bool StereoUniversalRequireDatm = false;
		bool StereoUniversalRequireZTest = false;
		bool StereoUniversalRequireZWrite = false;
		bool StereoUniversalRequireZTestAlways = false;
		bool StereoUniversalRequireZTestNever = false;
		bool StereoUniversalRequireAa1 = false;
		bool StereoUniversalRequireChannelShuffle = false;
		bool StereoUniversalRequireTextureShuffle = false;
		bool StereoUniversalRequireFullscreenShuffle = false;
		bool StereoUniversalRequirePoints = false;
		bool StereoUniversalRequireLines = false;
		bool StereoUniversalRequireTriangles = false;
		bool StereoUniversalRequireSprites = false;
		bool StereoUniversalRequireFixedQ = false;
		bool StereoUniversalRequireFixedZ = false;
		bool StereoUniversalRequireConstantColor = false;
		...
		bool StereoUiDetectSkyDepth = false;
		bool StereoUiDetectFst = false;
		bool StereoUiDetectFullscreenDrawArea = false;
		bool StereoUiDetectFullscreenSprite = false;
		bool StereoUiSecondLayerSelector1 = false;
		bool StereoUiSecondLayerSelector2 = false;
		bool StereoUiSecondLayerSelector3 = false;
		bool StereoUiSecondLayerSelector4 = false;
		bool StereoUiSecondLayerSelector5 = false;
		...
		bool StereoRejectSmallDrawArea = false;
		bool StereoRejectWideDrawBand = false;
		bool StereoRejectTopDrawBand = false;
		bool StereoRejectRtSpriteNoDepth = false;
		bool StereoRejectRtSpriteAlphaBlend = false;
		bool StereoRequireProcessTexture = false;
		bool StereoRejectProcessTexture = false;
		bool StereoRequireSourceFromTarget = false;
		bool StereoRejectSourceFromTarget = false;
		bool StereoRequireDrawUsesTarget = false;
		bool StereoRejectDrawUsesTarget = false;
		bool StereoRequireTexIsRt = false;
		bool StereoRejectTexIsRt = false;
		bool StereoRequireInTargetDraw = false;
		bool StereoRejectInTargetDraw = false;
		bool StereoRequireTempZ = false;
		bool StereoRejectTempZ = false;
		bool StereoRequireOneBarrier = false;
		bool StereoRejectOneBarrier = false;
		bool StereoRequireFullBarrier = false;
		bool StereoRejectFullBarrier = false;
		bool StereoRequireSinglePass = false;
		bool StereoRejectSinglePass = false;
		bool StereoRequireFullscreenDrawArea = false;
		bool StereoRejectFullscreenDrawArea = false;
		bool StereoRequireFullscreenSprite = false;
		bool StereoRejectFullscreenSprite = false;
		bool StereoRequireTexturedSprite = false;
		bool StereoRejectTexturedSprite = false;
		bool StereoRequireRtOutput = false;
		bool StereoRejectRtOutput = false;
		bool StereoRequireDepthOutput = false;
		bool StereoRejectDepthOutput = false;
		bool StereoRequireDepthRead = false;
		bool StereoRejectDepthRead = false;
		bool StereoRequireDepthWrite = false;
		bool StereoRejectDepthWrite = false;
		bool StereoRequirePalettedTexture = false;
		bool StereoRejectPalettedTexture = false;
		bool StereoRequireDepthTexture = false;
		bool StereoRejectDepthTexture = false;
		bool StereoRequireMipmap = false;
		bool StereoRejectMipmap = false;
		bool StereoRequireLinearSampling = false;
		bool StereoRejectLinearSampling = false;
		bool StereoRequireFmvActive = false;
		bool StereoRejectFmvActive = false;
		bool StereoRequireFmvHeuristic = false;
		bool StereoRejectFmvHeuristic = false;
		bool StereoRequireFmvSprite = false;
		bool StereoRejectFmvSprite = false;
		bool StereoRequireFmvSingleSprite = false;
		bool StereoRejectFmvSingleSprite = false;
		bool StereoRequireFmvTextureMapping = false;
		bool StereoRejectFmvTextureMapping = false;
		bool StereoRequireFmvProcessTexture = false;
		bool StereoRejectFmvProcessTexture = false;
		bool StereoRequireFmvFullscreenDrawArea = false;
		bool StereoRejectFmvFullscreenDrawArea = false;
		bool StereoRequireFmvFullscreenScissor = false;
		bool StereoRejectFmvFullscreenScissor = false;
		bool StereoRequireFmvNoAlphaBlend = false;
		bool StereoRejectFmvNoAlphaBlend = false;
		bool StereoRequireFmvNoAlphaTest = false;
		bool StereoRejectFmvNoAlphaTest = false;
		bool StereoRequireFmvNoDepthTest = false;
		bool StereoRejectFmvNoDepthTest = false;
		bool StereoRequireFmvNoDepthWrite = false;
		bool StereoRejectFmvNoDepthWrite = false;
		bool StereoRequireFmvNoDepthOutput = false;
		bool StereoRejectFmvNoDepthOutput = false;
		bool StereoRequireFmvNoDepthRead = false;
		bool StereoRejectFmvNoDepthRead = false;
		bool StereoRequireFmvNoFbMask = false;
		bool StereoRejectFmvNoFbMask = false;
		bool StereoRequireFmvColorOutput = false;
		bool StereoRejectFmvColorOutput = false;
		bool StereoRequireFmvSourceNotFromTarget = false;
		bool StereoRejectFmvSourceNotFromTarget = false;
		bool StereoRequireFmvDrawMatchesTex = false;
		bool StereoRejectFmvDrawMatchesTex = false;
		bool StereoRequireFmvNoShuffle = false;
		bool StereoRejectFmvNoShuffle = false;
		bool StereoRequireFmvNoMipmap = false;
		bool StereoRejectFmvNoMipmap = false;
		bool StereoRequireFmvLinearSampling = false;
		bool StereoRejectFmvLinearSampling = false;
		bool StereoRequireFmvEeUpload = false;
		bool StereoRejectFmvEeUpload = false;
		bool StereoRequireFmvDisplayMatch = false;
		bool StereoRejectFmvDisplayMatch = false;
		bool StereoRequireFmvRecentEeUpload = false;
		bool StereoRejectFmvRecentEeUpload = false;
		bool StereoRequireFmvRecentTransferDraw = false;
		bool StereoRejectFmvRecentTransferDraw = false;
		bool StereoRequireFeedbackLoopAny = false;
		bool StereoRejectFeedbackLoopAny = false;
		bool StereoRequireFeedbackLoopShader = false;
		bool StereoRejectFeedbackLoopShader = false;
		bool StereoRequireFeedbackLoopDrawUsesTarget = false;
		bool StereoRejectFeedbackLoopDrawUsesTarget = false;
		bool StereoRequireFeedbackLoopTexIsRt = false;
		bool StereoRejectFeedbackLoopTexIsRt = false;
		bool StereoRequireFeedbackLoopSourceFromTarget = false;
		bool StereoRejectFeedbackLoopSourceFromTarget = false;
		bool StereoRequireFeedbackLoopInTargetDraw = false;
		bool StereoRejectFeedbackLoopInTargetDraw = false;
		bool StereoRequireFeedbackLoopTempZ = false;
		bool StereoRejectFeedbackLoopTempZ = false;
		bool StereoRequireFeedbackLoopOverlapDrawRange = false;
		bool StereoRejectFeedbackLoopOverlapDrawRange = false;
		bool StereoFeedbackLoopDisableStereo = false;
		bool StereoFeedbackLoopClampToDominantEye = false;
		bool StereoFeedbackLoopSourceFromTargetOnly = false;
		bool StereoSbsRemapMono = false;
		bool StereoDisableInstancedRendering = false;
		int StereoSbsRemapFix = 2;
		int StereoFeedbackLoopFix = 2;
